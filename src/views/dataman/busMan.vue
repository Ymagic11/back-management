<template>
    ...
    <el-pagination background layout="slot, prev, pager, next" :total="num" @current-change="button"
        @prev-click="button" @next-click="button"
...
const button = () => {
    getUserList(currentpage.value,2).then(e => {
        data.pop()
